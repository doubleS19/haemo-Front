...
import 'package:haemo/controller/setting/setting_alarm_controller.dart';
...
class _SettingAlarmPageState extends State<SettingAlarmPage> {
  ...
  Widget switchMenuItem(
      BuildContext context, String text, int index, void onClick) {
    return Container(
        ...
        child:
          ...
          Text(index < 0 ? "푸시 알림 받기" : "${alarmList[index!]} 알림",
          ...
          CupertinoSwitch(
            ...
            onChanged: (bool? value) {
              setState(() {
                settingAlarmController.isCheckedList[index + 1] =
                    value ?? false;
                onClick;
              });
            },
