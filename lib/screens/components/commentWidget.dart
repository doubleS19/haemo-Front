...
import 'package:hae_mo/model/club_comment_model.dart';
...
Widget commentWidget(int pId, int type) {
  ...
  if (type == 1) {
    commentFuture = db.getCommentsByPId(pId);
  } else if (type == 2) {
    commentFuture = db.getClubCommentsByCpId(pId);
  } else {
    commentFuture = db.getHotPlaceCommentsByHpId(pId);
  }
